<template>
  <div class="app-container">
    ...
    @pagination="getList"/>
    <!-- 弹窗, 新增 / 修改 -->
    <button-form  ref="buttonForm" @refreshDataList="getList"/>
  </div>
</template>

<script>
  import buttonForm from './buttonForm'
  import {listButton,addButton,delButton,editButton,getButton} from "@/api/flowable/button";
  export default {
    data () {
      return {
        queryParams: {
    ...
    methods: {
      ...
      // 新增
      add() {
        this.$refs.buttonForm.init('add', undefined)
      },
      // 修改
      edit(row) {
