<template>
  <div class="app-container flex-main">
    ...
    <workflow-form-design ref="workflowFormDesign" @refresh="getList"/>
...
<script>
import { listFormDefinition, getFormDefinition, addFormDefinition, editFormDefinition, delFormDefinition } from '@/api/workflow/extension/formDefinition'
import { listFormCategory, delFormCategory } from '@/api/workflow/extension/formCategory'
import formCategoryForm from './helper/formCategoryForm'
import treeSelect from '@/components/TreeSelect'
import workflowFormDesign from './helper/workflowFormDesign'
import XEUtils from 'xe-utils'
export default {
  name: 'Form',
  components: { formCategoryForm, treeSelect, workflowFormDesign },
  data () {
    return {
      // 遮罩层
      loading: true,
