...
import com.entfrm.base.annotation.Excel.ColumnType;
import com.entfrm.base.annotation.Excel.Type;
import com.entfrm.base.annotation.Excels;
                ...
                for (Map.Entry<Integer, Field> entry : fieldsMap.entrySet()) {
                    ...
                    if (String.class == fieldType) {
                        ...
                        if (val instanceof String) {
                            val = com.entfrm.base.util.DateUtil.parseDate(val);
        ...
        try {
            ...
            if (attr.isExport()) {
                ...
                if (StrUtil.isNotEmpty(dateFormat) && !StrUtil.isEmptyIfStr(value)) {
                    cell.setCellValue(com.entfrm.base.util.DateUtil.parseDateToStr(dateFormat, (Date) value));
