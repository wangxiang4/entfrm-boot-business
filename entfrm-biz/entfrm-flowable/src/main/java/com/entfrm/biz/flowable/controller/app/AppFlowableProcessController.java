...
public class AppFlowableProcessController {
    ...
    public R setProcessInstanceStatus(@RequestParam String procDefId, @RequestParam String status) {
        flowableProcessService.setProcessInstanceStatus(procDefId, status);
        return R.ok();
    }
