  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="系统内置" prop="isSys">
        <el-select v-model="queryParams.isSys" placeholder="系统内置" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="configList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统内置" align="center" prop="isSys" :formatter="typeFormat" />
...
<script>
import { listConfig, getConfig, delConfig, addConfig, editConfig } from "@/api/system/config";
